...
{
    public partial class FormGenerateBoardWithP : Form
    {
        ...
        public FormGenerateBoardWithP(string id, string p)
        {
            InitializeComponent();
        ...
        private void FormGenerateBoardWithP_Load(object sender, EventArgs e)
        {
            List<Vertices> v = GetVertices(gameDetailsId);
            vertices = v.Select(v => new VerticesClingo(v)).ToList();
            ClingoCode clingoCode = new ClingoCode(vertices, parameter);
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            label5.Text = $"Parameter: {parameter}";
